...
Помогаешь сотруднику выстроить карьерный трек и понять что нужно для перехода на следующий уровень.
Отвечай на русском языке, конкретно и мотивирующе. Не более 120 слов. Без вступлений и заключений.
...
Ответь в формате: 1-2 предложения вывода + список из 3 конкретных шагов."""
